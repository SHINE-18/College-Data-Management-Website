...
const notices = [
    { id: 1, title: 'Mid-Semester Examination Schedule Released', category: 'Exam', date: 'Feb 20, 2026', content: 'The mid-semester examination schedule for all departments has been published. Students are requested to check the updated timetable on GTU portal.', postedBy: 'Examination Cell', attachment: true },
    { id: 2, title: 'New Admission Guidelines 2026-27', category: 'Admission', date: 'Feb 18, 2026', content: 'Applications are invited for admission to B.E. Computer Engineering for the academic year 2026-27 through ACPC.', postedBy: 'Admission Office', attachment: true },
    { id: 3, title: 'Annual Cultural Fest — Euphoria 2026', category: 'Events', date: 'Feb 15, 2026', content: 'Annual cultural festival will be held from March 15-17. All students are encouraged to participate.', postedBy: 'Cultural Committee', attachment: false },
];
...
const Home = () => (
    <div className="animate-fade-in">
        ...
        {/* ═══════ SECTION 2: Quick Access Cards (IIT Bombay-inspired) ═══════ */}
        ...
        {/* ═══════ SECTION 3: About the Department (IIT Madras-inspired) ═══════ */}
        ...
        {/* ═══════ SECTION 4: HOD's Message (IIT Madras-inspired) ═══════ */}
        ...
        {/* ═══════ SECTION 5: Research Areas (IIT Madras + IIT Bombay) ═══════ */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* ═══════ SECTION 6: Events & News (IIT Bombay-inspired) ═══════ */}
        <section className="bg-white py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    {/* Talks & Events — IIT Bombay date sidebar style */}
                    <div>
                    ...
                    {/* News — IIT Bombay icon card style */}
                    <div>
